...
#    And отправляем GET запрос на "https://petstore.swagger.io" эндпойнт "/v2/pet/" и проверяем, что запись по данному Pet <id> совпадает с отправленной из "request_body"
